        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(counter%3 ==1) {
                    ...
                    com.uridecy.demo.RequestFragment requestFragment = new com.uridecy.demo.RequestFragment();
                    if(empty1==0) {
                    ...
                    counter++;
                    com.uridecy.demo.RequestFragment requestFragment2 = new com.uridecy.demo.RequestFragment();
                    if(empty2==0) {
                        empty2=1;
                    ...
                    counter=1;
                    com.uridecy.demo.RequestFragment requestFragment3 = new com.uridecy.demo.RequestFragment();
                    if(empty1==0) {
                        empty3 =1;
